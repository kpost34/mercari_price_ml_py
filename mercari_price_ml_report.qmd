...
#| fig-cap: "Figure 2. Average log-transformed prices by *department*, *category*, *class*, and *brand_name* (5 most common and remaining)"
...
The Ridge Regression model with $\alpha = 5.0$ outperformed all other models on the Mercari training set with these features. 
<br>

## IV. Results & Interpretation

*Figure 3* shows that the model tends to under-predict log prices.
